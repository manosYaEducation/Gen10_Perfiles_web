...
loginF.addEventListener("submit", async (event) => {
  ...
  try {
    // Aquí cambiamos la URL del endpoint a la nueva dirección https://systemauth.alphadocere.cl/login.php
    const response = await fetch(
      'http://localhost/jwt-mail-qr/Version%202-%20SystemAuth/login.php',
      {
        method: 'POST',
        headers: {
