...
fetch('https://kreative.alphadocere.cl/backend/metrics.php') // http://localhost/Gen10_Perfiles_web/backend/metrics.php
  ...
  .then((data) => {
    document.getElementById('proyectos-count').textContent =
